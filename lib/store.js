...
var DefaultStorageStrategy_1 = require("./storage/strategy/DefaultStorageStrategy");
...
/** @param store */
function createReduxStore(store, reducers, preloadedState) {
    var _a = store.config, createReducer = _a.createReducer, states = _a.states;
    var rootReducer = createReducer(store, reducers);
...
var StateStore = /** @class */ (function () {
    ...
    function StateStore(config) {
        ...
        if (typeof storageAreas === "string" && storageAreas === "default") {
            ...
            if (!StorageStrat) {
                StorageStrat = DefaultStorageStrategy_1.DefaultStorageStrategy;
            }
        }
        ...
        var mapped = reducers_1.mapReducersOf(states);
        storageConfig['persistBlacklist'] = mapped.noPersist;
        storageConfig['persistPurgeKeys'] = mapped.defaultPurgeKeys;
        var redux = createReduxStore(this, mapped.reducers, mapped.preloadedState);
